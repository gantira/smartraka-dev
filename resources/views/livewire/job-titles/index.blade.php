                ...
                <div class="tab-pane fade show active" id="user-list" role="tabpanel">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">Job Title List</h3>
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-sm table-striped table-hover table-vcenter text-nowrap mb-0">
                                    ...
                                    <tbody>
                                        @forelse ($jobtitles as $item)
                                            <tr>
                                                <td>{{ $item->name }}</td>
                                                <td>{{ $item->created_at->format('m/d/Y') }}</td>
                                                <td>
                                                    <button wire:click="$emit('edit', {{ $item }})" type="button"
                                                        class="btn btn-icon btn-sm btn-sm" title="Edit"
                                                        data-toggle="tooltip" data-placement="top"><i
                                                            class="icon-note"></i></button>
                                                    <button wire:click="showConfirmation({{ $item->id }})" type="button"
