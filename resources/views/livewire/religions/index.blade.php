                                ...
                                <table class="table table-sm table-striped table-hover table-vcenter text-nowrap mb-0">
                                    ...
                                    <tbody>
                                        @forelse ($religions as $religion)
                                            <tr>
                                                <td>{{ $religion->name }}</td>
                                                <td>{{ $religion->created_at->format('m/d/Y') }}</td>
                                                <td>
                                                    <button wire:click="$emit('edit', {{ $religion }})" type="button"
                                                        class="btn btn-icon btn-sm btn-sm" title="Edit"
                                                        data-toggle="tooltip" data-placement="top"><i
                                                            class="icon-note"></i></button>
                                                    <button wire:click="showConfirmation({{ $religion->id }})" type="button"
