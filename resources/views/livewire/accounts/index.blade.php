                                    ...
                                    <tbody>
                                        @forelse ($accounts as $account)
                                            <tr>
                                                ...
                                                <td>{!! $account->status_badge_label !!}</td>
                                                <td>{{ $account->created_at->format('m/d/Y') }}</td>
                                                <td>
                                                    <button wire:click="$emit('edit', {{ $account }})" type="button"
                                                        class="btn btn-icon btn-sm btn-sm" title="Edit"
                                                        data-toggle="tooltip" data-placement="top"><i
                                                            class="icon-note"></i></button>
                                                    <button wire:click="showConfirmation({{ $account->id }})" type="button"
