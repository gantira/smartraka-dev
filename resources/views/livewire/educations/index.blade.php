                                    ...
                                    <tbody>
                                        @forelse ($educations as $education)
                                            <tr>
                                                ...
                                                <td>{{ $education->created_at->format('m/d/Y') }}</td>
                                                <td>
                                                    <button wire:click="$emit('edit', {{ $education }})" type="button"
                                                        class="btn btn-icon btn-sm btn-sm" title="Edit"
                                                        data-toggle="tooltip" data-placement="top"><i
                                                            class="icon-note"></i></button>
                                                    <button wire:click="showConfirmation({{ $education->id }})" type="button"
