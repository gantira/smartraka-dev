                ...
                <div class="tab-pane fade show active" id="user-list" role="tabpanel">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">Marital List</h3>
                                ...
                                <table class="table table-sm table-striped table-hover table-vcenter text-nowrap mb-0">
                                    ...
                                    <tbody>
                                        @forelse ($maritals as $marital)
                                            <tr>
                                                <td>{{ $marital->name }}</td>
                                                <td>{{ $marital->created_at->format('m/d/Y') }}</td>
                                                <td>
                                                    <button wire:click="$emit('edit', {{ $marital }})" type="button"
                                                        class="btn btn-icon btn-sm btn-sm" title="Edit"
                                                        data-toggle="tooltip" data-placement="top"><i
                                                            class="icon-note"></i></button>
                                                    <button wire:click="showConfirmation({{ $marital->id }})" type="button"
